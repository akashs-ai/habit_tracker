  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-8 space-y-6">
        ...
        <section className="bg-[#101722] border border-white/[0.08] rounded-2xl p-6 md:p-7 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/[0.06]">
            ...
            <button
              ...
              className="py-2 px-4 rounded-xl bg-[#141D2A] hover:bg-[#1A2536] border border-white/10 text-xs md:text-sm font-medium text-[#F5F7FB] transition-colors self-start sm:self-auto shadow-xs focus:outline-none focus:ring-2 focus:ring-[#5B5CE2]"
            >
              Edit Profile
            </button>
          </div>
          ...
          <div className="pt-6">
            <div className="flex flex-col sm:flex-row sm:items-center gap-5 mb-6">
              ...
              <div className="relative shrink-0">
                <img
                  ...
                  className="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover ring-2 ring-[#6366F1]/40 shadow-md"
                />
                <span className="absolute bottom-0 right-0 w-4 h-4 rounded-full bg-[#22C55E] ring-2 ring-[#101722]" />
              </div>

              {/* Name & Bio */}
              <div className="min-w-0">
                <div className="flex items-center gap-3 flex-wrap">
                  <h3 className="text-xl font-bold text-[#F5F7FB] tracking-tight">
                    {profile.displayName}
                  </h3>
                  <div className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-[#201B4B] text-[#818CF8] border border-[#6366F1]/30">
                ...
                <p className="text-xs md:text-sm text-[#94A3B8] mt-1.5 leading-relaxed italic">
                  “{profile.bio}”
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-white/[0.06] text-xs md:text-sm">
              <div className="bg-[#141D2A]/70 p-3.5 rounded-xl border border-white/[0.04]">
                <span className="text-[11px] font-medium text-[#64748B] uppercase tracking-wider block mb-1">
                  Email
                </span>
                <span className="text-[#F5F7FB] font-medium break-all">
                  {profile.email}
                </span>
              </div>
        ...
        {/* Quick Actions */}
        <div>
          <h3 className="text-sm font-semibold text-[#F5F7FB] mb-3 px-1">
            Quick actions
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <button
              ...
              className="group text-left p-5 rounded-2xl bg-[#101722] hover:bg-[#141D2A] border border-white/[0.08] hover:border-[#6366F1]/40 transition-all duration-150 hover:-translate-y-0.5 hover:shadow-md flex flex-col justify-between min-h-[120px]"
            >
              <div className="w-10 h-10 rounded-xl bg-[#201B4B] border border-[#6366F1]/30 flex items-center justify-center text-[#818CF8] mb-3 group-hover:scale-105 transition-transform">
                <KeyRound className="w-5 h-5" />
              </div>
              <div>
                <h4 className="text-sm font-bold text-[#F5F7FB] group-hover:text-[#818CF8] transition-colors">
                  Change password
                </h4>
      ...
      <div className="lg:col-span-4 space-y-5">
        {/* Inspirational Card */}
        <div className="relative rounded-2xl overflow-hidden border border-white/[0.08] shadow-sm p-6 flex flex-col justify-between min-h-[180px]">
        ...
        {/* Quick Menu List */}
        <div className="bg-[#101722] border border-white/[0.08] rounded-2xl overflow-hidden shadow-sm divide-y divide-white/[0.06]">
          {/* Item 1 */}
          <button
            type="button"
