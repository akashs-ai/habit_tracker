...
export const AppleLogo: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg viewBox="0 0 170 170" fill="currentColor" className={className}>
    <path d="M150.37 130.25c-2.45 5.66-5.35 10.87-8.71 15.66-4.58 6.53-8.33 11.05-11.22 13.56-4.48 4.12-9.28 6.23-14.42 6.35-3.69 0-8.14-1.05-13.32-3.18-5.19-2.12-9.97-3.17-14.34-3.17-4.58 0-9.49 1.05-14.75 3.17-5.26 2.13-9.5 3.24-12.74 3.35-4.35.13-9.16-1.9-14.42-6.08-3.69-3.04-7.59-7.71-11.72-14-4.7-7.28-8.52-15.65-11.45-25.1-2.93-9.45-4.4-18.7-4.4-27.75 0-14.89 3.8-27.35 11.41-37.38 7.61-10.02 17.15-15.15 28.61-15.39 5.34 0 10.97 1.34 16.89 4.02 5.92 2.68 9.77 4.07 11.55 4.17 1.45 0 5.48-1.5 12.09-4.5 6.61-3 12.55-4.35 17.82-4.06 13.78.73 24.58 5.76 32.41 15.09-11.96 7.23-17.81 16.94-17.55 29.13.25 9.75 4.06 17.9 11.41 24.47 7.36 6.57 16.14 10.3 26.36 11.2-.87 2.62-1.85 5.24-2.93 7.86zm-36.19-117.89c0 7.42-2.73 14.36-8.2 20.82-5.47 6.46-12.22 10.33-20.25 11.61-.25-1.12-.38-2.24-.38-3.37 0-7.3 2.87-14.28 8.61-20.93 5.74-6.65 12.63-10.42 20.67-11.31.25 1.05.38 2.11.38 3.18z" />
  </svg>
);
