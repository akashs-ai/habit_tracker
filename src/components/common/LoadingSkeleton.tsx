    ...
    <div className={`w-full flex flex-col gap-3 ${className}`}>
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="animate-pulse">
          {type === 'card' && (
            <div className="h-44 rounded-2xl bg-white/5 dark:bg-white/5 border border-white/5 p-4 flex flex-col justify-between">
          ...
          {type === 'row' && (
            <div className="h-14 rounded-xl bg-white/5 dark:bg-white/5 border border-white/5 px-4 flex items-center justify-between gap-4">
          ...
          {type === 'banner' && (
            <div className="h-32 rounded-3xl bg-white/5 dark:bg-white/5 border border-white/5 p-6 flex flex-col justify-between">
          ...
          {type === 'chart' && (
            <div className="h-52 rounded-2xl bg-white/5 dark:bg-white/5 border border-white/5 p-4 flex flex-col justify-end gap-2">
