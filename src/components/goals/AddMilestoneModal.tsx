      ...
      >
        ...
        <div className="flex items-center justify-between pb-4 border-b border-white/8">
          <div>
            ...
            <p className="text-xs text-[#697388] mt-0.5">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-5">
          ...
          {/* Actions */}
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-white/8 mt-2">
            <button
              type="button"
              onClick={onClose}
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-[#6C63FF] hover:bg-[#7B73FF] disabled:opacity-50 text-white text-xs font-semibold transition-colors shadow-xs"
            >
              Add Milestone
            </button>
          </div>
