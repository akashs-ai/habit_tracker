      ...
      >
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center justify-center p-4 rounded-xl border text-center transition-all cursor-pointer ${
                  isSelected
                    ? 'bg-[#6C63FF]/15 dark:bg-[#6C63FF]/20 border-[#6C63FF] shadow-xs'
                    : 'bg-slate-50 dark:bg-[#0E1118] hover:bg-slate-100 dark:hover:bg-[#181D27] border-slate-200 dark:border-white/8 text-slate-700 dark:text-[#A5AEC2] hover:text-slate-900 dark:hover:text-white'
                }`}
              >
                {/* Icon */}
                <div
        ...
        <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-200 dark:border-white/8">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-[#6C63FF] hover:bg-[#7B73FF] text-white text-xs font-semibold transition-colors shadow-xs cursor-pointer"
          >
            Confirm
          </button>
        </div>
